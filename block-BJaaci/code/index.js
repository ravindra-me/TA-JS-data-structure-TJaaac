...
for (const actor of movies[0].actors) {
  console.log(actor);
}
...
for (const genre of movies[2].genres) {
  console.log(genre);
}
...
for (const actor of movies[0].actors) {
  console.log(actor==="Rachel McAdams" ? true : false);
}
...
for (const actor of movies[1].actors) {
  console.log(actor==="Natalie Portman" ? true : false);
}
